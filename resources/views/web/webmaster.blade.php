...
<body>
    ...
    <script src="{{ asset('frutables/js/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('fruitables/js/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('fruitables/js/lib/lightbox/js/lightbox.min.js') }}"></script>
